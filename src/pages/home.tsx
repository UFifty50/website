...
import { CrankEngine, RustOS, UnitConverter } from "@/imgs/svgs.tsx";
import {
  Clipboard,
  ClipboardCheck,
  Copyright,
...
const projects: Feature[] = [
  {
    ...
    logo: CrankEngine,
    description:
      "2D-3D Game Engine written in C++ and OpenGL, with vulkan and DX11/12 support in the future.",
    link: "https://github.com/UFifty50/AnEngine/",
  },
  {
    title: "Rust-OS",
    logo: RustOS,
    description:
      "A basic Operating System written in rust to explore low-level driver development.",
    link: "https://github.com/UFifty50/ros/",
  },
  {
    title: "Unit Converter",
    logo: UnitConverter,
    description:
      "A basic F-to-C, C-to-F and leap year unit converter, implemented in multiple languages.",
    link: "https://github.com/UFifty50/Unit-Converter/",
  },
];

const Projects = {
  "Crank Engine": "https://github.com/Ufifty50/AnEngine",
  "Rust-OS": "https://github.com/Ufifty50/ros",
  "Unit Converter": "https://github.com/Ufifty50/Unit-Converter",
};
...
const Home = () => {
  ...
  useEventListener("keydown", (e) => {
    ...
    if (e.key === "Enter") {
      ...
      copyToClipboard(Object.keys(Projects)[currentIndex] as Project);
    }
  });
  ...
  const copyToClipboard = (pm: Project) => {
    setShowDropdown(false);
    setIsCopied(true);

    const text = `${Projects[pm]}`;
    ...
    <main className="layout min-h-screen w-full bg-[#141414] bg-fixed text-white selection:bg-zinc-300 selection:text-black">
      <section className="container px-4 py-12 md:px-6 md:pt-24 lg:pt-32 xl:pt-48">
        <img
          ...
          height={150}
          width={150}
          className="mx-auto mb-6 max-w-[200px] rounded-full md:max-w-full"
        />
          ...
          <div className="flex flex-col justify-center space-y-4 text-center">
            <div className="mb-6 space-y-2">
              ...
              <p className="mx-auto max-w-3xl text-sm text-zinc-200 sm:text-base md:text-xl">
                Hey! I'm Jonathan, a sixth-former and wannabe software engineer.
                I'm an avid gamer, software geek and programmer, and am self
                taught in Python, Rust, C++ and Java. Below you can see some of
            ...
            <div className="relative mx-auto max-w-xs rounded-xl border border-zinc-700 p-1 text-zinc-200 shadow-md duration-300 hover:shadow-black sm:max-w-full">
              <p className="flex w-full cursor-pointer items-center gap-2 rounded-md bg-white/5 px-2 py-3 font-mono hover:bg-white/10">
                ...
                <span className="truncate">
                  git clone https://github.com/UFifty50/
                </span>
              ...
              {showDropdown && (
                <div className="absolute -right-20 top-8 z-10 rounded-xl border border-zinc-700 p-1 hover:border-zinc-600">
                  <ul className="sticky flex flex-col rounded-md bg-zinc-800">
                    {(Object.keys(Projects) as Project[]).map((pm, i) => (
                      <button
                        key={i}
                        ref={(el) => {
                        ...
                        className="w-30 m-0.5 cursor-pointer rounded-md px-3 py-0.5 outline-none ring-zinc-600 hover:bg-zinc-700/50 hover:text-green-500 focus:ring-2"
                      >
                        {pm}
                      </button>
                    ))}
            ...
            <div className="flex flex-col items-center justify-center gap-4 md:flex-row">
              <a
                href="https://github.com/UFifty50"
                target="_blank"
      ...
      <section ref={projectsRef} className="container mt-10">
            ...
            >
              <div className="absolute inset-[1px] z-[2] flex flex-col gap-2.5 rounded-xl bg-[#141414] p-2.5">
                <div className="relative h-full w-full overflow-hidden rounded-md p-4">
                  <div className="mb-3.5 h-14 w-14">{<p.logo />}</div>
